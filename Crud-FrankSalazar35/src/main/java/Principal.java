...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("35_FrankSalazar");
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String celular = (String) TablaDatos.getValueAt(row, 1);
...
//            model=new DefaultTableModel(null,Titulos);   
            ...
            while (rs.next()) {
                ...
                persona[1] = rs.getString("celular");
    ...
    void Agregar() {
        String celular = txtDNI.getText();
        String nom = txtNom.getText();
        try {
            if (celular.equals("") || nom.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql = "insert into personas (celular,nombres) values('" + celular + "','" + nom + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        String celular = txtDNI.getText();
        String nom = txtNom.getText();
        String sql = "update Personas set celular='" + celular + "',nombres='" + nom + "' where Id=" + id;
        try {
            if (celular != null || nom != null) {
                con = cn.getConnection();
                st = con.createStatement();
                st.executeUpdate(sql);
